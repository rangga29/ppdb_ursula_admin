                            ...
                            <table class="table table-hover table-lg">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-auto">
                                            <img src="https://ppdb.santaursula-bdg.sch.id/upload/pas_foto/sd/<?= $sd->slug_nama_lengkap ?>"
                                ...
                                <table class="table table-hover table-lg">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-auto">
                                                <img src="https://ppdb.santaursula-bdg.sch.id/upload/scan_kk/sd/<?= $sd->slug_nama_lengkap ?>"
                                                    alt="<?= $dapodik->nama_lengkap ?>" style="max-width: 300px;">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="col-auto">
                                                <img src="https://ppdb.santaursula-bdg.sch.id/upload/scan_ak/sd/<?= $sd->slug_nama_lengkap ?>"
                                                    alt="<?= $dapodik->nama_lengkap ?>" style="max-width: 300px;">
                                            </td>
                                        </tr>
                                    </tbody>
