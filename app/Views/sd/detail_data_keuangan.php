                            ...
                            <table class="table table-hover table-lg">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-auto">
                                            <p class=" mb-0">
                                                <img src="https://ppdb.santaursula-bdg.sch.id/upload/bukti_pembayaran/sd/<?= $pembayaran_tahap_1->bukti_bayar ?>"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-auto">
                                            <p class=" mb-0">
                                                <img src="https://ppdb.santaursula-bdg.sch.id/upload/bukti_pembayaran/sd/<?= $pembayaran_tahap_2->bukti_bayar ?>"
                                                    alt="<?= $sd->nama_lengkap ?>" style="max-width: 300px;">
                                            </p>
                                        </td>
                                        <?php } else { ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-auto">
                                            <p class=" mb-0">
                                                <img src="https://ppdb.santaursula-bdg.sch.id/upload/bukti_pembayaran/sd/<?= $pembayaran_tahap_3->bukti_bayar ?>"
                                                    alt="<?= $sd->nama_lengkap ?>" style="max-width: 300px;">
                                            </p>
                                        </td>
                                        <?php } else { ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-auto">
                                            <p class=" mb-0">
                                                <img src="https://ppdb.santaursula-bdg.sch.id/upload/bukti_pembayaran/sd/<?= $pembayaran_tahap_4->bukti_bayar ?>"
                                                    alt="<?= $sd->nama_lengkap ?>" style="max-width: 300px;">
                                            </p>
                                        </td>
                                        <?php } else { ?>
