                                        ...
                                        <table class="table table-hover table-lg">
                                            <tbody>
                                                <tr>
                                                    <td class="col-4">
                                                        <div class="d-flex align-items-center">
                                                            <p class="font-bold ms-3 mb-0">Pengurangan Uang Pangkal</p>
                                                        </div>
                                                    </td>
                                                    <td class="col-auto">
                                                        <p class=" mb-0">
                                                            Rp.<?= number_format($beasiswa->uang_pangkal, 0, '', '.') ?>,-
                                                        </p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="col-4">
                                                        <div class="d-flex align-items-center">
                                                            <p class="font-bold ms-3 mb-0">Pengurangan Uang Sekolah</p>
                                                        </div>
                                                    </td>
                                                    <td class="col-auto">
                                                        <p class=" mb-0">
                                                            Rp.<?= number_format($beasiswa->uang_sekolah, 0, '', '.') ?>,-
                                                        </p>
                                                    </td>
                                                </tr>
                                            </tbody>
            ...
            <div class="col-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <?php endif ?>
                        <?php if (in_groups('admin_yayasan') || in_groups('superadmin')) : ?>
                        <div class="row">
                            <div class="col-6">
                                <div class="d-flex align-items-center">
                                    <p class="font-bold ms-3 mb-2 mt-2">Data Beasiswa</p>
                                </div>
                            </div>
                            <div class="col-auto">
                                <a href="/siswa_smp/beasiswa/<?= $smp['slug_nama_lengkap'] ?>"
                                    class="btn btn-primary">Beasiswa</a>
                            </div>
                        </div>
                        <?php endif ?>
                        <hr>
